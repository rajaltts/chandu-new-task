    ...
    const getScatterChartOption = (additionalSeries={}, additionalTooltip={}) => {
     ...
     switch (type) {
        ...
        case StackedBarChart:
            ...
            return <ReactCharts option={getLineChartOption({}, additionalSeries, {orient: 'horizontal', top: 'bottom'})} {...rest} />
        case StackedColumnChart:
            return <ReactCharts option={getLineChartOption({}, {type: 'bar', emphasis:{focus: 'series'}}, { orient: 'horizontal', top: 'bottom' })} {...rest} />
        case Scatter:
