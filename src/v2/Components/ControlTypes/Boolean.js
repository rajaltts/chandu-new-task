...
const Boolean = ({
    ...
    const { value, values, label, relaxed, valid, visible, enabled, default: defaultValue } = extractDataFromRules(rulesJson, name, intl)
    ...
    const handleChange = (event) => {
        ...
        onNewAssignment({ [name]: value }, ruleset, tags, () => {
