            ...
            {existingTemplates.length ?
                <>
                    <Typography className={paragraph} display="block" variant="subtitle2">
                        {translation("Existing_Template_Description", "Override existing template with current selection")}
                    </Typography>
                    <Autocomplete
                ...
                :
                <Typography className={paragraph} display="block" variant="subtitle2">
                    {isLoading ? translation("Loading", "Loading...") : translation("NoTemplate", "No Existing Templates")}
                </Typography>
            }
        </>
    )
