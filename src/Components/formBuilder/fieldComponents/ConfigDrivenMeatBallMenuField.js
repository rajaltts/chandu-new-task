...
const ConfigDrivenMeatBallMenuField = (props) => {
  const { rowData = {}, config = {} } = props;
              ...
              <Paper>
                <ClickAwayListener onClickAway={handleClose}>
                  <MenuList autoFocusItem={open} id="menu-list-grow" onKeyDown={handleListKeyDown} className={classes.menuList}>
                    {component && React.createElement(component, { closeDropdown: handleClose, rowData })}
                  </MenuList>
                </ClickAwayListener>
              </Paper>
            </Grow>
...
export default ConfigDrivenMeatBallMenuField;