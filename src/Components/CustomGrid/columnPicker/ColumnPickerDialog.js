...
const ColumnPickerDialog = (props) => {
    ...
    const searchColumns = (columns) =>
        columns.filter(
            (columnOption) => columnOption.displayName.toLowerCase().search(searchValue.toLowerCase()) !== -1
        )
    ...
    return (
        <ConfirmModal
            ...
            <Search searchValue={searchValue} onSearchQueryChange={onSearchQueryChange} />
