...
const ConfirmModalTemplate = ({ ...args }) => {
    ...
    const createActionsButton = (onButtonClick) => {
        return [
          {
            id: "Yes_Confirmtag",
            name: "Confirm",
    ...
    return <ConfirmModal  {...args} isModalOpen={isClose} onClose={closeConfrimModel}  actionButtonList={createActionsButton()} headerIcon={CheckCircleRoundedIcon} />
}
...
const ConfirmModalTemplateForOverrideCancelButton = ({ ...args }) => {
    ...
    return <ConfirmModal  {...args}  isModalOpen={isClose} onClose={closeConfrimModel}  overrideFooterCancelButton={overrideFooterCancelButton} actionButtonList={createActionsButton()} headerIcon={CheckCircleRoundedIcon} />
