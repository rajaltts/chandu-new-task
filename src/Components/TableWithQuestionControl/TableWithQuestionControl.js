...
import { Table, TableBody, TableCell, TableHead, TableRow, Paper, withStyles, makeStyles } from '@material-ui/core'
...
function TableWithQuestionControl(props) {
    ...
    function RenderTableBody() {
        return props.PropNames.map((PropName, idx) => {
            ...
            if (Visible === 'TRUE') {
                return (
                    <StyledTableRow key={idx} data-propname={PropName}>
                        ...
                        <StyledTableCell align='left'>{RenderTableCell(prop, 'Question', null)}</StyledTableCell>
    ...
    return (
        <Paper className='root' style={{ margin: '10px' }} id='ctrlQuestionaireTable'>
