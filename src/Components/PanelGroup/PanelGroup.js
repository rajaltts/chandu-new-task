        ...
        <div id="PanelSection" className="PanelSection" onClick={(e) => togglePanel(e)}>
            ...
            <div id="SubHeader" className="SubHeader">
                <h1 id="SubHeaderTitle" className="SubHeaderTitle">
                    {props.panelName}
                    {(ValidProp && !getBooleanValue(ValidProp.Value) || isRelaxed(props.RulesJSON, props.relaxedPropName)) 
                    && <span className="StepNotValidText NaApp"><FontAwesomeIcon icon={faExclamationCircle} size="lg" color="#CC0000"/></span>}
                </h1>
